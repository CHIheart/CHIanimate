...
c.clk_x=a.pageX-d.left,c.clk_y=a.pageY-d.top):(c.clk_x=a.pageX-h.offsetLeft,c.clk_y=a.pageY-h.offsetTop));setTimeout(function(){c.clk=c.clk_x=c.clk_y=null},100)}function r(){if(b.fn.ajaxSubmit.debug){var a="[jquery.form] "+Array.prototype.join.call(arguments,"");window.console&&window.console.log?window.console.log(a):window.opera&&window.opera.postError&&window.opera.postError(a)}}var A,B;A=void 0!==b("<input type='file'/>").get(0).files;B=void 0!==window.FormData;var D=!!b.fn.prop;b.fn.attr2=function(){if(!D)return this.attr.apply(this,
...
function c(c){function d(a){var b=null;try{a.contentWindow&&(b=a.contentWindow.document)}catch(c){r("cannot get iframe.contentWindow document: "+c)}if(b)return b;try{b=a.contentDocument?a.contentDocument:a.document}catch(e){r("cannot get iframe.contentDocument: "+e),b=a.document}return b}function f(){function a(){try{var b=d(v).readyState;r("state = "+b);b&&"uninitialized"==b.toLowerCase()&&setTimeout(a,50)}catch(c){r("Server abort: ",c," (",c.name,")"),h(2),u&&clearTimeout(u),u=void 0}}var c=n.attr2("target"),
k=n.attr2("action"),m=n.attr("enctype")||n.attr("encoding")||"multipart/form-data";l.setAttribute("target",s);g&&!/post/i.test(g)||l.setAttribute("method","POST");k!=e.url&&l.setAttribute("action",e.url);e.skipEncodingOverride||g&&!/post/i.test(g)||n.attr({encoding:"multipart/form-data",enctype:"multipart/form-data"});e.timeout&&(u=setTimeout(function(){y=!0;h(1)},e.timeout));var p=[];try{if(e.extraData)for(var q in e.extraData)e.extraData.hasOwnProperty(q)&&(b.isPlainObject(e.extraData[q])&&e.extraData[q].hasOwnProperty("name")&&
e.extraData[q].hasOwnProperty("value")?p.push(b('<input type="hidden" name="'+e.extraData[q].name+'">').val(e.extraData[q].value).appendTo(l)[0]):p.push(b('<input type="hidden" name="'+q+'">').val(e.extraData[q]).appendTo(l)[0]));e.iframeTarget||w.appendTo("body");v.attachEvent?v.attachEvent("onload",h):v.addEventListener("load",h,!1);setTimeout(a,15);try{l.submit()}catch(t){document.createElement("form").submit.apply(l)}}finally{l.setAttribute("action",k),l.setAttribute("enctype",m),c?l.setAttribute("target",
c):n.removeAttr("target"),b(p).remove()}}function h(a){if(!k.aborted&&!B)if(q=d(v),q||(r("cannot access response document"),a=2),1===a&&k)k.abort("timeout"),x.reject(k,"timeout");else if(2==a&&k)k.abort("server abort"),x.reject(k,"error","server abort");else if(q&&q.location.href!=e.iframeSrc||y){v.detachEvent?v.detachEvent("onload",h):v.removeEventListener("load",h,!1);a="success";var c;try{if(y)throw"timeout";var f="xml"==e.dataType||q.XMLDocument||b.isXMLDoc(q);r("isXml="+f);if(!f&&window.opera&&
(null===q.body||!q.body.innerHTML)&&--A){r("requeing onLoad callback, DOM not available");setTimeout(h,250);return}var g=q.body?q.body:q.documentElement;k.responseText=g?g.innerHTML:null;k.responseXML=q.XMLDocument?q.XMLDocument:q;f&&(e.dataType="xml");k.getResponseHeader=function(a){return{"content-type":e.dataType}[a.toLowerCase()]};g&&(k.status=Number(g.getAttribute("status"))||k.status,k.statusText=g.getAttribute("statusText")||k.statusText);var l=(e.dataType||"").toLowerCase(),m=/(json|script|text)/.test(l);
if(m||e.textarea){var n=q.getElementsByTagName("textarea")[0];if(n)k.responseText=n.value,k.status=Number(n.getAttribute("status"))||k.status,k.statusText=n.getAttribute("statusText")||k.statusText;else if(m){var p=q.getElementsByTagName("pre")[0],s=q.getElementsByTagName("body")[0];p?k.responseText=p.textContent?p.textContent:p.innerText:s&&(k.responseText=s.textContent?s.textContent:s.innerText)}}else"xml"==l&&!k.responseXML&&k.responseText&&(k.responseXML=C(k.responseText));try{z=G(k,l,e)}catch(F){a=
"parsererror",k.error=c=F||a}}catch(E){r("error caught: ",E),a="error",k.error=c=E||a}k.aborted&&(r("upload aborted"),a=null);k.status&&(a=200<=k.status&&300>k.status||304===k.status?"success":"error");"success"===a?(e.success&&e.success.call(e.context,z,"success",k),x.resolve(k.responseText,"success",k),t&&b.event.trigger("ajaxSuccess",[k,e])):a&&(void 0===c&&(c=k.statusText),e.error&&e.error.call(e.context,k,a,c),x.reject(k,"error",c),t&&b.event.trigger("ajaxError",[k,e,c]));t&&b.event.trigger("ajaxComplete",
[k,e]);t&&!--b.active&&b.event.trigger("ajaxStop");e.complete&&e.complete.call(e.context,k,a);B=!0;e.timeout&&clearTimeout(u);setTimeout(function(){e.iframeTarget?w.attr("src",e.iframeSrc):w.remove();k.responseXML=null},100)}}var l=n[0],m,e,t,s,w,v,k,y,u,x=b.Deferred();x.abort=function(a){k.abort(a)};if(c)for(m=0;m<p.length;m++)c=b(p[m]),D?c.prop("disabled",!1):c.removeAttr("disabled");e=b.extend(!0,{},b.ajaxSettings,a);e.context=e.context||e;s="jqFormIO"+(new Date).getTime();e.iframeTarget?(w=b(e.iframeTarget),
(m=w.attr2("name"))?s=m:w.attr2("name",s)):(w=b('<iframe name="'+s+'" src="../'+e.iframeSrc+'" />'),w.css({position:"absolute",top:"-1000px",left:"-1000px"}));v=w[0];k={aborted:0,responseText:null,responseXML:null,status:0,statusText:"n/a",getAllResponseHeaders:function(){},getResponseHeader:function(){},setRequestHeader:function(){},abort:function(a){var c="timeout"===a?"timeout":"aborted";r("aborting upload... "+c);this.aborted=1;try{v.contentWindow.document.execCommand&&v.contentWindow.document.execCommand("Stop")}catch(d){}w.attr("src",
e.iframeSrc);k.error=c;e.error&&e.error.call(e.context,k,c,a);t&&b.event.trigger("ajaxError",[k,e,c]);e.complete&&e.complete.call(e.context,k,c)}};(t=e.global)&&0===b.active++&&b.event.trigger("ajaxStart");t&&b.event.trigger("ajaxSend",[k,e]);if(e.beforeSend&&!1===e.beforeSend.call(e.context,k,e))return e.global&&b.active--,x.reject(),x;if(k.aborted)return x.reject(),x;(c=l.clk)&&(m=c.name)&&!c.disabled&&(e.extraData=e.extraData||{},e.extraData[m]=c.value,"image"==c.type&&(e.extraData[m+".x"]=l.clk_x,
...
this;f=b.param(t,m);l&&(f=f?f+"&"+l:l);"GET"==a.type.toUpperCase()?(a.url+=(0<=a.url.indexOf("?")?"&":"?")+f,a.data=null):a.data=f;var s=[];a.resetForm&&s.push(function(){n.resetForm()});a.clearForm&&s.push(function(){n.clearForm(a.includeHidden)});if(!a.dataType&&a.target){var y=a.success||function(){};s.push(function(c){var d=a.replaceTarget?"replaceWith":"html";b(a.target)[d](c).each(y,arguments)})}else a.success&&s.push(a.success);a.success=function(b,c,d){for(var f=a.context||this,g=0,h=s.length;g<
h;g++)s[g].apply(f,[b,c,d||n,n])};if(a.error){var u=a.error;a.error=function(b,c,d){u.apply(a.context||this,[b,c,d,n])}}if(a.complete){var C=a.complete;a.complete=function(b,c){C.apply(a.context||this,[b,c,n])}}l=0<b("input[type=file]:enabled",this).filter(function(){return""!==b(this).val()}).length;f="multipart/form-data"==n.attr("enctype")||"multipart/form-data"==n.attr("encoding");m=A&&B;r("fileAPI :"+m);var z;!1!==a.iframe&&(a.iframe||(l||f)&&!m)?a.closeKeepAlive?b.get(a.closeKeepAlive,function(){z=
c(t)}):z=c(t):z=(l||f)&&m?d(t):b.ajax(a);n.removeData("jqxhr").data("jqxhr",z);for(l=0;l<p.length;l++)p[l]=null;this.trigger("form-submit-notify",[this,a]);return this};b.fn.ajaxForm=function(a){a=a||{};a.delegation=a.delegation&&b.isFunction(b.fn.on);if(!a.delegation&&0===this.length){var h=this.selector,d=this.context;if(!b.isReady&&h)return r("DOM not ready, queuing ajaxForm"),b(function(){b(h,d).ajaxForm(a)}),this;r("terminating; zero elements found by selector"+(b.isReady?"":" (DOM not ready)"));
