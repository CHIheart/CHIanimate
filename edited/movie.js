...
oOptions，附加参数列表对象，可以使用的属性有
	...
	.delay，为滚动时间间隔，默认为3000，不为0，越大滚动越慢
	.mstop，鼠标指向时停止开关，默认为true
	.minLi，为最少的显示数量，如果少于这个数量就不执行特效，默认为1
	.auto，是否自动播放，默认为true
	.limit，在边界时是否禁止循环滚动，默认为false，即在最后一个时，点next会回滚到第一个，反则相同
	*****如果为true的话，而且有设置控制器 oControllers 中的 prev 和 next 的话，会在不可播放时，给这两个控制器加上类disabled
